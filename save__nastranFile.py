...
def save__nastranFile( points=None, cells=None, matNums=None, outFile="nastran.bdf", \
                       index_plus_1=True, nodes_format=None ):

    # element number :: [ 1 ~ nElems ]
    # node    number :: [ 1 ~ nNodes ]
